...
public final class AllItems {
    ...
    public static final ItemEntry<? extends CopperRespiratorItem> COPPER_RESPIRATOR = REGISTRATE
    ...
    public static final ItemEntry<? extends NetheriteRespiratorItem> NETHERITE_RESPIRATOR = REGISTRATE
